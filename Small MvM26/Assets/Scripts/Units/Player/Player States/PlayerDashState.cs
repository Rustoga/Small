...
{
    public class PlayerDashState : UnitState
    {
        PlayerStateMachine _sm;
        PlayerAnimationSystem _animationSystem;
        PlayerSoundSystem _soundSystem;

        public override string DebugStateName => "dash state";
        static readonly PlayerAnimationState _animationstate = PlayerAnimationState.Dash;

        public override Unit.AnimationState AnimationState => _animationstate;

        public PlayerDashState(UnitStateMachine stateMachine,
        ...
        {
            _soundSystem.PlaySound(_soundSystem.DashSound, false);
